    ...
    for issue in r_json:
        ...
        if 'pull_request' not in issue:
            ...
            rowvalues = [repo_name, issue['number'], issue['title'],
                         userstory, sPipeline, issue['user']['login'], issue['created_at'],
                         issue['milestone']['title'] if issue['milestone']
                         else "", issue['milestone']['due_on'] if issue['milestone'] else "",
                         sAssigneeList[:-1], lEstimateValue, sPriority, sLabels, comments]
            ...
            print(f'You have skipped {ISSUES} Pull Requests')
